...
@Stable
class IonTypography internal constructor(
    head1: TextStyle,
    head2: TextStyle,
    sub1: TextStyle,
    sub2: TextStyle,
    ...
    fun copy(): IonTypography = IonTypography(
        head1 = head1,
        head2 = head2,
        sub1 = sub1,
        sub2 = sub2,
    ...
    fun update(typography: IonTypography) {
...
@Composable
fun IonTypography(): IonTypography {
    return IonTypography(
        head1 = IonTextStyle(
