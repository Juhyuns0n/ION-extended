...
val brown300 = Color(0xFFD2B48C) // 밝은 베이지-브라운
val brown500 = Color(0xFFA67C52) // 중간 브라운
val brown700 = Color(0xFF7B5733) // 짙은 브라운
...
class IonColors(
    ...
    var sand100 by mutableStateOf(sand100)
        private set
    var orange300 by mutableStateOf(Color(0xFFFF7759L))
        private set
    ...
    var gray900Alpha80 by mutableStateOf(gray900Alpha80)
        private set
    var brown300 by mutableStateOf(brown300)
        private set
    var brown500 by mutableStateOf(brown500)
        private set
    var brown700 by mutableStateOf(brown700)
        private set

    var isLight by mutableStateOf(isLight)

    fun copy(): IonColors = IonColors(
        beige,
        primary50,
        primary100,
        primary200,
...
fun IonDarkColors(
    beige: Color = com.ion.app.core.designsystem.ui.theme.beige,
